...
namespace Mediapipe.Unity.Sample.Holistic
{
  ...
  {
    [SerializeField] private bool drawSampleAnnotations = true;
    ...
    protected override IEnumerator Run()
    {
      ...
      // NOTE: The screen is optional for minimal scenes.
      if (screen != null)
      {
        screen.Initialize(imageSource);
      }
      if (drawSampleAnnotations && _worldAnnotationArea != null)
      {
      ...
      if (!runningMode.IsSynchronous() && drawSampleAnnotations)
      {
